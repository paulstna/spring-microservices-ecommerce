...
import com.paulstna.order.exception.ResourceNotFoundException;
import com.paulstna.order.constants.MessageConstants;
import com.paulstna.order.dto.OrderResponseDTO;
import com.paulstna.order.dto.PlaceOrderRequestDTO;
import com.paulstna.order.mapper.OrderMapper;
...
import com.paulstna.order.repository.OrderRepository;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public OrderResponseDTO placeOrder(PlaceOrderRequestDTO request) {
        ...
        /*
         * TODO: Trigger the saga from here.
         */
    ...
    public OrderResponseDTO cancelOrder(UUID orderId) {
        ...
        if (order.getStatus() != OrderStatus.CREATED) {
            /*
             * TODO: Trigger the saga compensation process here.
             */
