...
public class OrderController {
    ...
    public ResponseEntity<OrderResponseDTO> placeOrder(
        ...
        return ResponseEntity
                ...
                .body(orchestrator.placeOrder(request, correlationId));
    }
